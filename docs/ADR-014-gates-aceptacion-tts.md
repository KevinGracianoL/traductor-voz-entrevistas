...
| Pipeline end-to-end (audio -> primer sample audible, UNA corrida encadenada, 100 % atribuido, 19 corridas validas de 20) | inferido 1489 ms | **rango 1237.0-1469.3 ms | p50 1259.6** | **< 2000 ms -> PASA (0 de 4 sobre el limite)** |
