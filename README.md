...
- [x] **Fase 2f — Go/no-go del motor TTS** — **XTTS-v2 ACEPTADO por los gates medidos** del [ADR-014](docs/ADR-014-gates-aceptacion-tts.md): pipeline end-to-end **1127.5-1238.8 ms < 2000 ms**, 100 % atribuido por fronteras y estable en dos corridas (ASR 771-812 + traducción 177-182 + TTFA 721-755 + ruteo primer-sample 221-224); aprobación final condicionada a los gates de sesión (ADR-019). Candidato B (Supertonic 3 + OpenVoice V2) **rechazado** por TTFA arquitectural (7885.8 ms)
