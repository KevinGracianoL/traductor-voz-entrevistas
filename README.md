...
| ¿Qué no probé? | **coverage** | **100 %** (642 stmts, 0 sin cubrir) |
...
>
> **201 tests** cubren el happy path **y** los modos de fallo: locks de antivirus, escrituras truncadas, `.tmp` huérfanos, rutas Windows con backslash/apóstrofo.
...
├── tests/                      # 201 tests, 100 % cov, mutantes en CI
